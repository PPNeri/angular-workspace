...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var pe=function(){function e(){this.className=e.defaultProps.className,this.prefix=r.components.prefix}return e.defaultProps={className:""},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-navbar }",template:"<div [ngClass]=\"[prefix + '-navbar', className]\">\n  <ng-content></ng-content>\n</div>\n"}]}],e.propDecorators={className:[{type:t.Input}]},e}();var ce=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[pe],exports:[pe],imports:[n.CommonModule]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var ue=function(){function e(){this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.id=e.defaultProps.id,this.name=e.defaultProps.name,this.required=e.defaultProps.required,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isActive=!1,this.isFocused=!1,this.onClickEmitter=new t.EventEmitter}return e.prototype.onClick=function(){this.disabled||(this.isActive=!this.isActive,this.isFocused=!1,this.onClickEmitter.emit(this.value))},e.prototype.onBlur=function(){this.isFocused=!1},e.prototype.onFocus=function(){this.disabled||(this.isFocused=!0)},e.defaultProps={className:"",disabled:!1,id:null,name:"",required:!1,value:""},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-radio }",template:'<div\n  [ngClass]="[prefix + \'-radio\', className]"\n  [class.active]="isActive"\n  [class.disabled]="disabled"\n  [class.focused]="isFocused"\n  [tabindex]="disabled ? \'-1\': \'0\'"\n\n  (click)="onClick()"\n  (blur)="onBlur()"\n  (focus)="onFocus()"\n>\n  <div [ngClass]="prefix + \'-radio-label\'">\n    <ng-content></ng-content>\n  </div>\n\n  <div [ngClass]="prefix + \'-radio-indicator\'">\n    <div [ngClass]="prefix + \'-radio-indicator-ripple\'" materializeRipple [isRippleActive]="!disabled" [rippleDuration]="200"></div>\n  </div>\n\n  <input type="radio" [attr.id]="id" [checked]="isActive" [disabled]="disabled" [name]="name" [required]="required" [value]= "value" />\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={onClickEmitter:[{type:t.Output,args:["onClick"]}],className:[{type:t.Input}],disabled:[{type:t.Input}],id:[{type:t.Input}],name:[{type:t.Input}],required:[{type:t.Input}],value:[{type:t.Input}]},e}();var de=function(){function e(){this.canUncheck=e.defaultProps.canUncheck,this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.name=e.defaultProps.name,this.required=e.defaultProps.required,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isFocused=!1,this.initRadios=this.initRadios.bind(this),this.registerRadios=this.registerRadios.bind(this),this.toggleRadios=this.toggleRadios.bind(this),this.onChangeEmitter=new t.EventEmitter}return e.prototype.ngAfterContentInit=function(){this.initRadios(),this.radiosQueryList.changes.subscribe(this.initRadios)},e.prototype.initRadios=function(){this.disableAllRadios(this.disabled),setTimeout(this.registerRadios,0)},e.prototype.registerRadios=function(){var e=this;this.radiosQueryList.forEach(function(t){t.isActive=t.value===e.value,t.onClickEmitter.subscribe(e.toggleRadios)})},e.prototype.toggleRadios=function(e){this.setValueAllRadios(e);var t=this.radiosQueryList.find(function(t){return t.value===e});this.value=t&&t.isActive?t.value:"",this.onTouched(),this.onChange(this.value),this.onChangeEmitter.emit(this.value)},e.prototype.setValueAllRadios=function(e){var t=this;this.radiosQueryList.forEach(function(n){n.value!==e&&(n.isActive=!1),n.value!==e||t.canUncheck||(n.isActive=!0)})},e.prototype.disableAllRadios=function(e){this.radiosQueryList.forEach(function(t){t.disabled=e})},e.prototype.setDisabledState=function(e){var t=this;this.disabled=e,setTimeout(function(){t.disableAllRadios(t.disabled)},0)},e.prototype.writeValue=function(e){var t=this;this.value=e,setTimeout(function(){t.setValueAllRadios(t.value)},0)},e.prototype.registerOnChange=function(e){this.onChange=e},e.prototype.registerOnTouched=function(e){this.onTouched=e},e.prototype.onChange=function(e){},e.prototype.onTouched=function(){},e.defaultProps={canUncheck:!1,className:"",disabled:!1,name:"",required:!1,value:""},e.decorators=[{type:t.Component,args:[{providers:[{multi:!0,provide:i.NG_VALUE_ACCESSOR,useExisting:t.forwardRef(function(){return e})}],selector:r.components.prefix+"-radio-group }",template:'<div [ngClass]="[prefix + \'-radio-group\', className]">\n  <ng-content select="materialize-radio"></ng-content>\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={radiosQueryList:[{type:t.ContentChildren,args:[ue]}],onChangeEmitter:[{type:t.Output,args:["onChange"]}],canUncheck:[{type:t.Input}],className:[{type:t.Input}],disabled:[{type:t.Input}],name:[{type:t.Input}],required:[{type:t.Input}],value:[{type:t.Input}]},e}();var he=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[ue,de],exports:[ue,de],imports:[n.CommonModule,m]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var me=function(){function e(){this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.transitionDuration=e.defaultProps.transitionDuration,this.isActive=!1,this.onClickEmitter=new t.EventEmitter,this.emitClick=this.emitClick.bind(this)}return e.prototype.ngAfterContentChecked=function(){this.content=this.optionTemplateRef.nativeElement?this.optionTemplateRef.nativeElement.textContent:""},e.prototype.onClick=function(){this.disabled||setTimeout(this.emitClick,this.transitionDuration)},e.prototype.emitClick=function(){this.onClickEmitter.emit(this.value)},e.defaultProps={className:"",disabled:!1,transitionDuration:250,value:""},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-select-option }",template:'<div [ngClass]="[prefix + \'-select-option\', className]" materializeRipple (click)="onClick()" [class.active]="isActive" [rippleDuration]="transitionDuration">\n  <div #optionTemplate>\n    <span>\n      <ng-content></ng-content>\n    </span>\n  </div>\n</div>\n \n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={optionTemplateRef:[{type:t.ViewChild,args:["optionTemplate",{static:!0}]}],onClickEmitter:[{type:t.Output,args:["onClick"]}],className:[{type:t.Input}],disabled:[{type:t.Input}],value:[{type:t.Input}]},e}();var fe=function(){function e(n){this.renderer=n,this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.floatLabel=e.defaultProps.floatLabel,this.id=e.defaultProps.id,this.isNativeControl=e.defaultProps.isNativeControl,this.name=e.defaultProps.name,this.required=e.defaultProps.required,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isFocused=!1,this.isOpen=!1,this.onChangeEmitter=new t.EventEmitter,this.addBackdropListener=this.addBackdropListener.bind(this),this.onChangeOption=this.onChangeOption.bind(this),this.registerOptions=this.registerOptions.bind(this)}return e.prototype.ngAfterContentInit=function(){var e=this;setTimeout(this.registerOptions,0),this.options.changes.subscribe(function(t){setTimeout(e.registerOptions,0)})},e.prototype.registerOptions=function(){var e=this;this.options.forEach(function(t){t.isActive=t.value===e.value,t.onClickEmitter.subscribe(e.onChangeOption)}),this.updateControl(this.value)},e.prototype.updateControl=function(e){this.value=e,this.isOpen=!1,this.activeSelectedOption(this.value)},e.prototype.onChangeOption=function(e){this.updateControl(e),this.onChangeEmitter.emit(this.value),this.onChange(this.value)},e.prototype.activeSelectedOption=function(e){var t=this;this.options.forEach(function(n){n.value===e?(n.isActive=!0,t.cloneOption(n)):n.isActive=!1})},e.prototype.cloneOption=function(e){if(this.labelContainerRef){var t=this.labelContainerRef.nativeElement,n=e.optionTemplateRef;if(t.firstChild&&this.renderer.removeChild(t,t.firstChild),n){var i=n.nativeElement.firstChild.cloneNode(!0);this.renderer.appendChild(t,i)}}},e.prototype.onChangeNativeOption=function(e){var t=e.target.selectedOptions[0].value;this.value=t,this.onChangeEmitter.emit(this.value),this.onChange(this.value)},e.prototype.onBlur=function(){this.isFocused=!1},e.prototype.onFocus=function(){this.disabled||(this.isFocused=!0,this.onTouched())},e.prototype.onClick=function(){this.disabled||(this.isFocused=!0,this.isOpen=!0,this.isNativeControl||setTimeout(this.addBackdropListener,0))},e.prototype.addBackdropListener=function(){var e=this;this.backdropRef.nativeElement.addEventListener("click",function(){e.isOpen=!1})},e.prototype.setDisabledState=function(e){this.disabled=e},e.prototype.writeValue=function(e){var t=this;this.value=e,setTimeout(function(){t.updateControl(t.value)},0)},e.prototype.registerOnChange=function(e){this.onChange=e},e.prototype.registerOnTouched=function(e){this.onTouched=e},e.prototype.onChange=function(e){},e.prototype.onTouched=function(){},e.defaultProps={className:"",disabled:!1,floatLabel:"",id:null,isNativeControl:!1,name:"",required:!1,value:null},e.decorators=[{type:t.Component,args:[{providers:[{multi:!0,provide:i.NG_VALUE_ACCESSOR,useExisting:t.forwardRef(function(){return e})}],selector:r.components.prefix+"-select }",template:'<div [ngClass]="[className, prefix + \'-form-control-select-container\']" *ngIf="isNativeControl">\n  <div [ngClass]="prefix + \'-form-control-container\'"\n    [class.float-label]="floatLabel"\n    [class.active]="value"\n    [class.focused]="isFocused"\n    [class.disabled]="disabled"\n  >\n    <div [ngClass]="prefix + \'-form-control-wrapper\'">\n      <div [ngClass]="prefix + \'-form-control-label\'">{{ floatLabel }}</div>\n\n      <select (blur)="onBlur()" (click)="onClick()" (focus)="onFocus()" (input)="onChangeNativeOption($event)"\n        [ngClass]="prefix + \'-form-control\'"\n        [attr.id]="id"\n        [disabled]="disabled"\n        [name]="name"\n        [required]="required"\n        [value]="value"\n      >\n        <option\n          [selected]="option.value === value"\n          [value]="option.value"\n          *ngFor="let option of options">\n          {{ option.content }}\n        </option>\n      </select>\n    </div>\n\n    <materialize-icon [className]="prefix + \'-form-control-select-icon\'" size="lg">arrow_drop_down</materialize-icon>\n  </div>\n</div>\n\n\n<div (focus)="onFocus()" (blur)="onBlur()" *ngIf="!isNativeControl"\n  [ngClass]="[className, prefix + \'-form-control-select-container\']"\n  [class.open]="isOpen"\n  [tabindex]="disabled ? \'-1\' : \'0\'"\n>\n  <div #backdrop *ngIf="isOpen" [ngClass]="prefix + \'-form-control-select-backdrop\'"></div>\n\n  <div (click)="onClick()"\n    [ngClass]="[prefix + \'-form-control-container\' , className]"\n    [class.float-label]="floatLabel"\n    [class.active]="value"\n    [class.focused]="isFocused"\n    [class.disabled]="disabled"\n  >\n    <div [ngClass]="prefix + \'-form-control-wrapper\'">\n      <div [ngClass]="prefix + \'-form-control-label\'">{{ floatLabel }}</div>\n      <div [ngClass]="prefix + \'-form-control\'" #labelContainer>&nbsp;</div>\n    </div>\n\n    <materialize-icon [className]="prefix + \'-form-control-select-icon\'" size="lg">arrow_drop_down</materialize-icon>\n  </div>\n\n  <div [className]="prefix + \'-form-control-select-menu\'">\n    <ng-content select="materialize-select-option"></ng-content>\n  </div>\n</div>\n'}]}],e.ctorParameters=function(){return[{type:t.Renderer2}]},e.propDecorators={backdropRef:[{type:t.ViewChild,args:["backdrop",{static:!1}]}],labelContainerRef:[{type:t.ViewChild,args:["labelContainer",{static:!1}]}],options:[{type:t.ContentChildren,args:[me]}],onChangeEmitter:[{type:t.Output,args:["onChange"]}],className:[{type:t.Input}],disabled:[{type:t.Input}],floatLabel:[{type:t.Input}],id:[{type:t.Input}],isNativeControl:[{type:t.Input}],name:[{type:t.Input}],required:[{type:t.Input}],value:[{type:t.Input}]},e}();var ge=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[fe,me],exports:[fe,me],imports:[n.CommonModule,m,v]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */
var ve={down:"mousedown",move:"mousemove",resize:"resize",up:"mouseup"},ye={down:"touchstart",move:"touchmove",resize:"resize",up:"touchend"};function Ce(){return"ontouchstart"in window}var be=function(){return Ce()?ye:ve},xe=function(){function e(){this.className=e.defaultProps.className,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isActive=!1}return e.defaultProps={className:"",value:null},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-slider-option }",template:'<div [ngClass]="[prefix + \'-slider-option-container\', className]"\n  [class.active]="isActive"\n\n  #template>\n  <ng-content></ng-content>\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={templateRef:[{type:t.ViewChild,args:["template",{static:!0}]}],className:[{type:t.Input}],value:[{type:t.Input}]},e}();var Ee=function(){function e(n){this.renderer=n,this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.required=e.defaultProps.required,this.showLabels=e.defaultProps.showLabels,this.showTicks=e.defaultProps.showTicks,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isFocused=!1,this.supportedEvents=be(),this.onChangeEmitter=new t.EventEmitter,this.actionDown=this.actionDown.bind(this),this.actionMove=this.actionMove.bind(this),this.actionUp=this.actionUp.bind(this),this.update=this.update.bind(this),window.addEventListener(this.supportedEvents.resize,this.update)}return e.prototype.ngAfterViewInit=function(){this.sliderTrack.nativeElement.addEventListener(this.supportedEvents.down,this.actionDown)},e.prototype.ngAfterContentInit=function(){this.update(),this.options.changes.subscribe(this.update)},e.prototype.update=function(){var e=this;setTimeout(function(){e.renderPositions(),e.moveToValue(e.value,!1)},0)},e.prototype.renderPositions=function(){var t=this,n=this.getPixelInterval();this.removeTicks(),this.options.forEach(function(i,o){var s=n*o,r=i.templateRef.nativeElement;if(t.renderer.setStyle(r,"left",s+"px"),t.showTicks){var a=t.renderer.createElement("div");t.renderer.setStyle(a,"left",s+"px"),t.renderer.addClass(a,e.tickClassName),t.renderer.appendChild(t.sliderTrackInterval.nativeElement,a)}})},e.prototype.removeTicks=function(){for(var e=this.sliderTrackInterval.nativeElement;e.firstChild;)this.renderer.removeChild(e,e.firstChild)},e.prototype.actionDown=function(e){if(!this.disabled){var t=this.getXCoordinate(e,this.supportedEvents.down);this.animate(t,!0),window.addEventListener(this.supportedEvents.up,this.actionUp),window.addEventListener(this.supportedEvents.move,this.actionMove)}},e.prototype.actionMove=function(e){var t=this.getXCoordinate(e,this.supportedEvents.move);this.value=this.getValueFromXCoordinate(t),this.animate(t,!1)},e.prototype.actionUp=function(e){window.removeEventListener(this.supportedEvents.up,this.actionUp),window.removeEventListener(this.supportedEvents.move,this.actionMove),this.renderer.setStyle(this.sliderIndicatorContainer.nativeElement,"transitionDuration",null);var t=this.getXCoordinate(e,this.supportedEvents.up);this.value=this.getValueFromXCoordinate(t),this.onChangeEmitter.emit(this.value),this.onChange(this.value),this.moveToValue(this.value,!0)},e.prototype.moveToValue=function(e,t){var n=this.options.toArray().findIndex(function(t){return t.value===e}),i=(n>=0?n:0)*this.getPixelInterval();this.animate(i,t)},e.prototype.activeOption=function(e){this.options.forEach(function(t){t.isActive=t.value===e})},e.prototype.getValueFromXCoordinate=function(e){var t=this.getIndexFromXCoordinate(e);return this.options.toArray()[t].value},e.prototype.getIndexFromXCoordinate=function(e){var t=this.getPixelInterval();if(t){var n=Math.round(e/t);if(n>=0&&n<=this.options.length)return n}return 0},e.prototype.getXCoordinateByEventType=function(e,t){return Ce()?t===this.supportedEvents.up?e.changedTouches[0].clientX:e.touches[0].clientX:e.clientX},e.prototype.getXCoordinate=function(e,t){var n=this.sliderTrack.nativeElement.getBoundingClientRect(),i=this.getXCoordinateByEventType(e,t)-n.left;return i<0?0:i>this.sliderTrack.nativeElement.offsetWidth?this.sliderTrack.nativeElement.offsetWidth:i},e.prototype.getPixelInterval=function(){var e=this.options.length-1;return e>0?this.sliderTrack.nativeElement.offsetWidth/e:0},e.prototype.animate=function(e,t){this.activeOption(this.value);var n=t?null:"0ms";this.renderer.setStyle(this.sliderIndicatorContainer.nativeElement,"transitionDuration",n),this.renderer.setStyle(this.sliderIndicatorContainer.nativeElement,"left",e+"px")},e.prototype.onFocus=function(){this.disabled||(this.isFocused=!0,this.onTouched())},e.prototype.onBlur=function(){this.isFocused=!1},e.prototype.setDisabledState=function(e){this.disabled=e},e.prototype.writeValue=function(e){var t=this;setTimeout(function(){t.value=e,t.moveToValue(e,!1)},0)},e.prototype.registerOnChange=function(e){this.onChange=e},e.prototype.registerOnTouched=function(e){this.onTouched=e},e.prototype.onChange=function(e){},e.prototype.onTouched=function(){},e.tickClassName=r.components.prefix+"-slider-step",e.defaultProps={className:"",disabled:!1,required:!1,showLabels:!0,showTicks:!1,value:null},e.decorators=[{type:t.Component,args:[{providers:[{multi:!0,provide:i.NG_VALUE_ACCESSOR,useExisting:t.forwardRef(function(){return e})}],selector:r.components.prefix+"-slider }",template:'<div [ngClass]="[prefix + \'-slider\', className]" [class.focused]="isFocused" [class.disabled]="disabled">\n\n  <div [ngClass]="prefix + \'-slider-track-container\'" #sliderTrack [tabindex]="disabled ? \'-1\' : \'0\'" (focus)="onFocus()" (blur)="onBlur()">\n    <div #sliderTrackInterval></div>\n\n    <div [ngClass]="prefix + \'-slider-track\'" #sliderTrackBackground></div>\n\n    <div [ngClass]="prefix + \'-slider-indicator-container\'" #sliderIndicatorContainer>\n      <ng-content select="materialize-slider-indicator"></ng-content>\n    </div>\n  </div>\n\n  <div [ngClass]="prefix + \'-slider-labels-container\'" *ngIf="showLabels">\n    <ng-content select="materialize-slider-option"></ng-content>\n  </div>\n</div>\n'}]}],e.ctorParameters=function(){return[{type:t.Renderer2}]},e.propDecorators={options:[{type:t.ContentChildren,args:[xe]}],Slider:[{type:t.ViewChild,args:["Slider",{static:!0}]}],sliderIndicatorContainer:[{type:t.ViewChild,args:["sliderIndicatorContainer",{static:!0}]}],sliderTrack:[{type:t.ViewChild,args:["sliderTrack",{static:!0}]}],sliderTrackBackground:[{type:t.ViewChild,args:["sliderTrackBackground",{static:!0}]}],sliderTrackInterval:[{type:t.ViewChild,args:["sliderTrackInterval",{static:!0}]}],onChangeEmitter:[{type:t.Output,args:["onChange"]}],className:[{type:t.Input}],disabled:[{type:t.Input}],required:[{type:t.Input}],showLabels:[{type:t.Input}],showTicks:[{type:t.Input}],value:[{type:t.Input}]},e}();var Ie=function(){function e(){}return e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-slider-indicator }",template:"<ng-content></ng-content>\n"}]}],e}(),Ne=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[Ee,Ie,xe],exports:[Ee,Ie,xe],imports:[n.CommonModule]}]}],e}();var Pe=function(){function e(){this.prefix=r.components.prefix,this.isCompleted=!1}return e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-step }",template:'<ng-template #indicatorTemplate>\n  <div [ngClass]="prefix + \'-step-indicator\'">\n    <materialize-icon [className]="prefix + \'-step-indicator-icon\'" *ngIf="isCompleted">done</materialize-icon>\n    <ng-content select="materialize-step-indicator" *ngIf="!isCompleted"></ng-content>\n  </div>\n</ng-template>\n<ng-template #labelTemplate>\n  <ng-content select="materialize-step-label"></ng-content>\n</ng-template>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={labelTemplate:[{type:t.ViewChild,args:["labelTemplate",{static:!1}]}],indicatorTemplate:[{type:t.ViewChild,args:["indicatorTemplate",{static:!1}]}]},e}();var Te=function(){function e(){this.prefix=r.components.prefix}return e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-step-indicator",template:"<ng-content></ng-content>\n"}]}],e}();var ke=function(){function e(){this.prefix=r.components.prefix}return e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-step-label",template:"<div [className]=\"prefix + '-step-label'\">\n  <ng-content></ng-content>\n</div>\n"}]}],e}();var Oe=function(){function e(){this.className=e.defaultProps.className,this.activeIndex=e.defaultProps.activeIndex,this.showTicks=e.defaultProps.showTicks,this.prefix=r.components.prefix,this.isContentReady=!0,this.validateContent=this.validateContent.bind(this)}return e.prototype.ngAfterContentInit=function(){this.validateContent(),this.steps.changes.subscribe(this.validateContent)},e.prototype.validateContent=function(){var e=this;setTimeout(function(){e.isContentReady=!1,e.validateSteps()},0)},e.prototype.validateSteps=function(){var e=this;this.steps.forEach(function(t,n){t.isCompleted=n<e.activeIndex&&e.showTicks})},e.defaultProps={activeIndex:0,className:"",showTicks:!0},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-stepper }",template:'<div [ngClass]="[prefix + \'-stepper\', className]">\n  <ng-container *ngFor="let step of steps; index as i">\n    <div [ngClass]="prefix + \'-step-divider\'" *ngIf="i > 0" [class.completed]="i <= activeIndex"></div>\n\n    <div\n      [ngClass]="prefix + \'-step\'"\n      [class.active]="i === activeIndex"\n      [class.completed]="i < activeIndex"\n      *ngIf="!isContentReady"\n    >\n      <ng-template [ngTemplateOutlet]="step.indicatorTemplate"></ng-template>\n      <ng-template [ngTemplateOutlet]="step.labelTemplate"></ng-template>\n    </div>\n  </ng-container>\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={className:[{type:t.Input}],activeIndex:[{type:t.Input}],showTicks:[{type:t.Input}],steps:[{type:t.ContentChildren,args:[Pe]}]},e}();var we=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[Pe,Te,ke,Oe],exports:[Pe,Te,ke,Oe],imports:[n.CommonModule,v]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var De=function(){function e(){this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.id=e.defaultProps.id,this.name=e.defaultProps.name,this.required=e.defaultProps.required,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isFocused=!1,this.onChangeEmitter=new t.EventEmitter}return e.prototype.toggleValue=function(){this.disabled||(this.isFocused=!1,this.value=!this.value,this.onChange(this.value),this.onChangeEmitter.emit(this.value))},e.prototype.onBlur=function(){this.isFocused=!1},e.prototype.onFocus=function(){this.disabled||(this.isFocused=!0,this.onTouched())},e.prototype.setDisabledState=function(e){this.disabled=e},e.prototype.writeValue=function(e){this.value=e},e.prototype.registerOnChange=function(e){this.onChange=e},e.prototype.registerOnTouched=function(e){this.onTouched=e},e.prototype.onChange=function(e){},e.prototype.onTouched=function(){},e.defaultProps={className:"",disabled:!1,id:null,name:"",required:!1,value:!1},e.decorators=[{type:t.Component,args:[{providers:[{multi:!0,provide:i.NG_VALUE_ACCESSOR,useExisting:t.forwardRef(function(){return e})}],selector:r.components.prefix+"-switch }",template:'<div [ngClass]="[prefix + \'-switch\', className]"\n\n  (click)="toggleValue()"\n  (focus)="onFocus()"\n  (blur)="onBlur()"\n\n  [class.active]="value"\n  [class.disabled]="disabled"\n  [class.focused]="isFocused"\n  [tabindex]="disabled ? \'-1\': \'0\'"\n>\n  <div [ngClass]="prefix + \'-switch-label\'">\n    <ng-content></ng-content>\n  </div>\n\n  <div [ngClass]="prefix + \'-switch-track\'">\n    <div [ngClass]="prefix + \'-switch-indicator\'">\n      <div [ngClass]="prefix + \'-switch-indicator-ripple\'" materializeRipple [isRippleActive]="!disabled" [rippleDuration]="200"></div>\n    </div>\n  </div>\n\n  <input type="checkbox" [disabled]="disabled" [attr.id]="id" [name]="name" [required]="required" [value]="value" />\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={className:[{type:t.Input}],disabled:[{type:t.Input}],id:[{type:t.Input}],name:[{type:t.Input}],required:[{type:t.Input}],value:[{type:t.Input}],onChangeEmitter:[{type:t.Output,args:["onChange"]}]},e}();var Se=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[De],exports:[De],imports:[n.CommonModule,m]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var Me=function(){function e(){this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.link=e.defaultProps.link,this.title=e.defaultProps.title,this.isActive=!1}return e.defaultProps={className:"",disabled:!1,link:"",title:""},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-tab }",template:'<div [hidden]="!isActive" [ngClass]="className">\n  <ng-content></ng-content>\n</div>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={className:[{type:t.Input}],disabled:[{type:t.Input}],link:[{type:t.Input}],title:[{type:t.Input}]},e}();var Re=function(){function e(n,i){this.router=n,this.renderer=i,this.className=e.defaultProps.className,this.selectedIndex=e.defaultProps.selectedIndex,this.transitionDuration=e.defaultProps.transitionDuration,this.prefix=r.components.prefix,this.onTabSelectEmitter=new t.EventEmitter,this.supportedEvents=be(),this.update=this.update.bind(this),window.addEventListener(this.supportedEvents.resize,this.update)}return e.prototype.ngAfterViewInit=function(){setTimeout(this.update,250)},e.prototype.ngOnChanges=function(e){e.selectedIndex&&!e.selectedIndex.isFirstChange()&&this.moveIndicator(e.selectedIndex.currentValue,!0)},e.prototype.update=function(){this.moveIndicator(this.selectedIndex,!1)},e.prototype.selectTab=function(e){var t=this,n=this.tabs.toArray()[e];n.disabled||(this.selectedIndex=e,this.onTabSelectEmitter.emit(e),this.moveIndicator(this.selectedIndex,!0),n.link&&setTimeout(function(){t.router.navigate([n.link])},this.transitionDuration))},e.prototype.activateIndex=function(e){this.tabs.forEach(function(t,n){t.isActive=n===e})},e.prototype.moveIndicator=function(e,t){this.activateIndex(e);var n=this.headerRef.nativeElement.children[e],i=t?this.transitionDuration+"ms":null;this.renderer.setStyle(this.indicatorRef.nativeElement,"transitionDuration",i),this.renderer.setStyle(this.indicatorRef.nativeElement,"width",n.offsetWidth+"px"),this.renderer.setStyle(this.indicatorRef.nativeElement,"transform","translateX("+n.offsetLeft+"px)")},e.defaultProps={className:"",selectedIndex:0,transitionDuration:450},e.decorators=[{type:t.Component,args:[{selector:r.components.prefix+"-tab-group }",template:'<div [ngClass]="className">\n  <ul [ngClass]="prefix + \'-tab-group\'" #header>\n\n    <li (click)="selectTab(i)"\n      *ngFor="let tab of tabs; let i = index"\n\n      [ngClass]="prefix + \'-tab-group-item\'"\n      [class.active]="i === selectedIndex"\n      [class.disabled]="tab.disabled"\n      [isRippleActive]="!tab.disabled"\n\n      materializeRipple\n    >\n      {{ tab.title }}\n    </li>\n\n    <div [ngClass]="prefix + \'-tab-group-indicator-container\'" #indicator>\n      <div [ngClass]="prefix + \'-tab-group-indicator\'"></div>\n    </div>\n  </ul>\n  \n  <div>\n    <ng-content select="materialize-tab"></ng-content>\n  </div>\n</div>\n'}]}],e.ctorParameters=function(){return[{type:o.Router},{type:t.Renderer2}]},e.propDecorators={tabs:[{type:t.ContentChildren,args:[Me]}],indicatorRef:[{type:t.ViewChild,args:["indicator",{static:!0}]}],headerRef:[{type:t.ViewChild,args:["header",{static:!0}]}],onTabSelectEmitter:[{type:t.Output,args:["onSelectTab"]}],className:[{type:t.Input}],selectedIndex:[{type:t.Input}],transitionDuration:[{type:t.Input}]},e}();var Le=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[Me,Re],exports:[Me,Re],imports:[n.CommonModule,m]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */var Be=function(){function e(){this.className=e.defaultProps.className,this.disabled=e.defaultProps.disabled,this.floatLabel=e.defaultProps.floatLabel,this.hasCounter=e.defaultProps.hasCounter,this.id=e.defaultProps.id,this.maxLength=e.defaultProps.maxLength,this.minLength=e.defaultProps.minLength,this.name=e.defaultProps.name,this.placeholder=e.defaultProps.placeholder,this.required=e.defaultProps.required,this.rows=e.defaultProps.rows,this.value=e.defaultProps.value,this.prefix=r.components.prefix,this.isFocused=!1,this.onBlurEmitter=new t.EventEmitter,this.onChangeEmitter=new t.EventEmitter,this.onFocusEmitter=new t.EventEmitter}return e.prototype.onBlur=function(){this.onBlurEmitter.emit(),this.isFocused=!1},e.prototype.onFocus=function(){this.disabled||(this.isFocused=!0,this.onTouched(),this.onFocusEmitter.emit())},e.prototype.onChange=function(e){var t=e.target.value;this.value=t,this.onChangeEmitter.emit(e),this.onTextAreaChange(t)},e.prototype.setDisabledState=function(e){this.disabled=e},e.prototype.writeValue=function(e){this.value=e},e.prototype.registerOnChange=function(e){this.onTextAreaChange=e},e.prototype.registerOnTouched=function(e){this.onTouched=e},e.prototype.onTextAreaChange=function(e){},e.prototype.onTouched=function(){},e.defaultProps={className:"",disabled:!1,floatLabel:"",hasCounter:!1,id:null,maxLength:500,minLength:0,name:"",placeholder:"",required:!1,rows:1,value:""},e.decorators=[{type:t.Component,args:[{providers:[{multi:!0,provide:i.NG_VALUE_ACCESSOR,useExisting:t.forwardRef(function(){return e})}],selector:r.components.prefix+"-textarea }",template:'<div (blur)="onBlur()" (focus)="onFocus()"\n  [ngClass]="[prefix + \'-form-control-container\', className]"\n  [class.float-label]="floatLabel"\n  [class.active]="value || placeholder"\n  [class.focused]="isFocused"\n  [class.disabled]="disabled"\n>\n  <div [ngClass]="prefix + \'-form-control-wrapper\'">\n    <div [ngClass]="prefix + \'-form-control-label\'">{{ floatLabel }}</div>\n\n    <textarea (input)="onChange($event)" (blur)="onBlur()" (focus)="onFocus()"\n      [ngClass]="prefix + \'-form-control\'"\n      [disabled]="disabled"\n      [attr.id]="id"\n      [maxLength]="maxLength"\n      [minLength]="minLength"\n      [name]="name"\n      [placeholder]="placeholder"\n      [required]="required"\n      [rows]="rows"\n      [value]="value">\n    </textarea>\n  </div>\n</div>\n\n<materialize-form-message type="info" *ngIf="hasCounter">{{ value.length }} / {{ maxLength }}</materialize-form-message>\n'}]}],e.ctorParameters=function(){return[]},e.propDecorators={onFocusEmitter:[{type:t.Output,args:["onFocus"]}],onChangeEmitter:[{type:t.Output,args:["onChange"]}],onBlurEmitter:[{type:t.Output,args:["onBlur"]}],className:[{type:t.Input}],disabled:[{type:t.Input}],floatLabel:[{type:t.Input}],hasCounter:[{type:t.Input}],id:[{type:t.Input}],maxLength:[{type:t.Input}],minLength:[{type:t.Input}],name:[{type:t.Input}],placeholder:[{type:t.Input}],required:[{type:t.Input}],rows:[{type:t.Input}],value:[{type:t.Input}]},e}();var Ae=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{declarations:[Be],exports:[Be],imports:[n.CommonModule,m,q]}]}],e}();
/**
     * @license
     * Copyright Workylab. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://raw.githubusercontent.com/workylab/materialize-angular/master/LICENSE
     */e.AccordionComponent=l,e.BUTTON_LEVELS=b,e.BUTTON_TYPES=x,e.ButtonComponent=E,e.ButtonToggleComponent=N,e.ButtonToggleGroupComponent=P,e.CalendarComponent=w,e.CardComponent=S,e.CheckboxComponent=R,e.CollapsibleComponent=a,e.CollapsibleContentComponent=p,e.CollapsibleTitleComponent=c,e.DRAWER_POSITIONS=X,e.DRAWER_TYPES=G,e.DatePickerComponent=A,e.DrawerComponent=W,e.DrawerContainerComponent=H,e.DrawerContentComponent=j,e.DrawerModel=U,e.FORM_MESSAGE_LEVELS=F,e.FormMessageComponent=V,e.GlossaryComponent=$,e.GlossaryItemComponent=K,e.HTMLVisualizerComponent=ie,e.ICON_SIZES=f,e.INPUT_TYPE=B,e.IconComponent=g,e.InputComponent=z,e.LabelComponent=se,e.MaterializeAccordionModule=C,e.MaterializeButtonModule=I,e.MaterializeButtonToggleGroupModule=T,e.MaterializeCalendarModule=D,e.MaterializeCardModule=M,e.MaterializeCheckboxModule=L,e.MaterializeCollapsibleModule=y,e.MaterializeCommonModule=m,e.MaterializeDatePickerModule=Y,e.MaterializeDrawerModule=Q,e.MaterializeFormMessageModule=q,e.MaterializeGlossaryModule=ne,e.MaterializeHTMLVisualizerModule=oe,e.MaterializeIconModule=v,e.MaterializeInputModule=_,e.MaterializeLabelModule=re,e.MaterializeModalModule=le,e.MaterializeNavbarModule=ce,e.MaterializeRadioGroupModule=he,e.MaterializeScrollSpyModule=te,e.MaterializeSelectModule=ge,e.MaterializeSliderModule=Ne,e.MaterializeStepperModule=we,e.MaterializeSwitchModule=Se,e.MaterializeTabGroupModule=Le,e.MaterializeTextAreaModule=Ae,e.ModalComponent=ae,e.NavbarComponent=pe,e.PrefixDirective=u,e.RadioComponent=ue,e.RadioGroupComponent=de,e.RippleDirective=d,e.ScrollSpyComponent=ee,e.ScrollSpyItemComponent=Z,e.SelectComponent=fe,e.SelectOptionComponent=me,e.SliderComponent=Ee,e.SliderIndicatorComponent=Ie,e.SliderOptionComponent=xe,e.StepComponent=Pe,e.StepIndicatorComponent=Te,e.StepLabelComponent=ke,e.StepperComponent=Oe,e.SuffixDirective=h,e.SwitchComponent=De,e.TabComponent=Me,e.TabGroupComponent=Re,e.TextAreaComponent=Be,e.ɵa=r,Object.defineProperty(e,"__esModule",{value:!0})});
//# sourceMappingURL=materialize-angular.umd.min.js.map